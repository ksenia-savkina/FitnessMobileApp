...
public class UpcomingClassesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_upcomingclasses, container, false);
        super.onCreate(savedInstanceState);
        id = getArguments().getInt(AuthorizationFragment.ID);

        listViewClasses = (ListView) v.findViewById(R.id.listViewUpcomingClasses);
    ...
    private void loadData() {
        ...
        try {
            ...
            if (view != null) {
                clientClasses = view.clientUpcomingClasses;
            }
            list = new ArrayList<>();
